...
const PrivacyPolicy = () => {
  return (
    <div className="pt-[60px] privacy-policy-section">
      <p>
      ...
      <h2 className="text-[28px] font-bold">Interpretation and Definitions</h2>
      <h3 className="text-[24px] font-bold">Interpretation</h3>
      <p>
      ...
      <h3 className="text-[24px] font-bold">Definitions</h3>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Spority.
          </p>
        </li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Spority, accessible from{" "}
            <Link
              href="https://spority.live/"
      ...
      <h3 className="text-[24px] font-bold">Types of Data Collected</h3>
      <h4 className="text-[20px] font-bold">Personal Data</h4>
      <p>
      ...
      <h3 className="text-[24px] font-bold">Use of Your Personal Data</h3>
      ...
      <h3 className="text-[24px] font-bold">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="text-[24px] font-bold">Delete Your Personal Data</h3>
      <p>
      ...
      <h4 className="text-[20px] font-bold">Business Transactions</h4>
      <p>
      ...
      <h4 className="text-[20px] font-bold">Law enforcement</h4>
      <p>
      ...
      <h4 className="text-[20px] font-bold">Other legal requirements</h4>
      <p>
      ...
      <h3 className="text-[24px] font-bold">Security of Your Personal Data</h3>
      <p>
      ...
      <h2 className="text-[28px] font-bold">Links to Other Websites</h2>
      <p>
      ...
      <h2 className="text-[28px] font-bold">Changes to this Privacy Policy</h2>
      <p>
      ...
      <ul>
        <li>
          <p>By email: contactus@spority.live</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <Link
              href="https://spority.live/Contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://spority.live/Contact
            </Link>
          </p>
        </li>
        <li>
          <p>By phone number: +92-325-7390-045</p>
        </li>
      </ul>
    </div>
  );
