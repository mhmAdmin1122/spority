...
const PostForm = () => {
  return (
    <form className="flex flex-col gap-6 justify-center py-6 items-center w-full">
      ...
      <div className="flex flex-col gap-3 w-[83%]">
        <h2 className="text-left w-full text-xl font-bold">Video 1</h2>
        <div className="bg-[#fff] px-6 py-3 w-full">
          <input type="file" />
        </div>
      </div>
      <div className="flex flex-col gap-3 w-[83%]">
        <h2 className="text-left w-full text-xl font-bold">Video 2</h2>
        <div className="bg-[#fff] px-6 py-3 w-full">
          <input type="file" />
        </div>
      </div>

      <button type="submit" className="bg-colored-post-btn px-5 py-2">Submit Now</button>
    </form>
  );
};
